...
<body>
<nav class="navbar navbar-expand-lg navbar-light col-xs-12" style="background-color: #111421;">
  <a class="navbar-brand" href="index.php">Metropolis</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="movie nav-item">
        <a class="nav-link" href="liste-des-films.php"><span class="icon"><i class="fas fa-film"></span></i>Films</a>
      </li>
      <li class="nav-item">
